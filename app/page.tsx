  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="nextjs, solo sparks, growth, self-awareness" />
      ...
      <div className="layout">
        <div className="container">
          <main className="main">
            ...
            <p className="p">Your journey to emotional intelligence begins here!!</p>

            <div className="section">
              <div className="card">
                <h2>Already on a Growth Journey?</h2>
                <p>Log in to access your personalized quests and progress dashboard.</p>
                <Link href="/login"><button>Login</button></Link>
              </div>

              <div className="card">
                <h2>New Here? Start Growing</h2>
                <p>Create your free account to get tailored self-growth activities and earn spark points!</p>
            ...
            <div className="features-clean">
              ...
              <p className="features-subtitle">We believe self-growth should be exciting, personal, and rewarding. Here’s what makes us different:</p>
